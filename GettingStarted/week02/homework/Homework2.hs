...
mkValidator () (CustomRedeemer t f) _ = traceIfFalse "wrong redeemer" $ t == f
...
grab :: forall w s e. (HasBlockchainActions s, AsContractError e) => CustomRedeemer -> Contract w s e ()
grab r = do
