...
newtype Slot = Slot { getSlot :: Integer } -- Slot is defined newType wrapper on Integer :: Slot is just an integer
...
type SlotRange = Interval Slot -- The definition of Slot range
